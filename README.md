...
<p>The great motivation and challenge for researchers at the time was to develop nonlinear navigation. See Harrower and Fabrikant (2008). In 2009, I developed an event-driven programming algorithm to synchronise maps with video and video with maps. Video can be advanced or rewound using the video selector or by capturing and dragging the mobile system's location icon (a car) along the map route.</p>
